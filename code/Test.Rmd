...
cleanData$war <- ifelse(grepl("War", cleanData$genre) == "TRUE", 1, 0) %>% as.integer()
...
cleanData$musical <- ifelse(grepl("Musical|Music", cleanData$genre) == "TRUE", 1, 0) %>% as.integer()
cleanData$family <- ifelse(grepl("Family", cleanData$genre) == "TRUE", 1, 0) %>% as.integer()
cleanData$western <- ifelse(grepl("Western", cleanData$genre) == "TRUE", 1, 0) %>% as.integer()
cleanData$sport <- ifelse(grepl("Sport", cleanData$genre) == "TRUE", 1, 0) %>% as.integer()
cleanData$music <- ifelse(grepl("Music", cleanData$genre) == "TRUE", 1, 0) %>% as.integer()
cleanData$scifi <- ifelse(grepl("Sci-Fi", cleanData$genre) == "TRUE", 1, 0) %>% as.integer()
cleanData$filmnoir <- ifelse(grepl("Film-Noir", cleanData$genre) == "TRUE", 1, 0) %>% as.integer()
cleanData$animation <- ifelse(grepl("Animation", cleanData$genre) == "TRUE", 1, 0) %>% as.integer()
cleanData$history <- ifelse(grepl("History", cleanData$genre) == "TRUE", 1, 0) %>% as.integer()
cleanData$horror <- ifelse(grepl("Horror", cleanData$genre) == "TRUE", 1, 0) %>% as.integer()
cleanData$fantasy <- ifelse(grepl("Fantasy", cleanData$genre) == "TRUE", 1, 0) %>% as.integer()
cleanData$music <- ifelse(grepl("Music", cleanData$genre) == "TRUE", 1, 0) %>% as.integer()
cleanData$scifi <- ifelse(grepl("Sci-Fi|Sci", cleanData$genre) == "TRUE", 1, 0) %>% as.integer()
